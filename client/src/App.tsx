      ...
      <div className="relative z-10 min-h-screen flex flex-col">
        ...
        <header className="flex items-center justify-between p-4 bg-white/20 backdrop-blur-sm border-b border-white/30">
          <div className="flex items-center gap-4">
            ...
            {last&&<button onClick={resumeLesson} className="px-3 py-2 rounded-full bg-[rgb(var(--brand-600))] text-white hover:bg-[rgb(var(--brand-700))] font-medium transition ease-out">Resume: {findLesson(last.biome,last.id,LESSONS)?.title}</button>}
          </div>
