...
export default function App(){
  ...
  return (
    <div className={cx("relative min-h-screen bg-gradient-to-br overflow-hidden", BG_BY_TOD[tod])}>
      ...
      {/* Activity Player */}
      <ActivityPlayer open={activityPlayer.open} onClose={()=>setActivityPlayer({open:false,biome:null,lesson:null})} biome={activityPlayer.biome} lesson={activityPlayer.lesson} onMarkComplete={(id)=>markComplete(activityPlayer.biome,id)} protoOnly={protoOnly}/>
