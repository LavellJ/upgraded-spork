        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-[1200px] h-[900px]">
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 900" style={{ zIndex: 50, pointerEvents: "none" }}>
              {/* Base Path */}
              <motion.path
                d="M 238 300 C 350 180, 750 180, 1088 300 C 1150 350, 1120 450, 1080 520 C 1040 590, 980 650, 900 680 C 820 710, 720 720, 620 700 C 520 680, 480 640, 460 600 C 440 560, 430 520, 410 480 C 390 440, 370 460, 350 490 C 330 520, 310 550, 290 580 C 270 610, 240 640, 200 650 C 160 660, 120 640, 100 600 C 80 560, 70 500, 80 450 C 90 400, 120 360, 160 330 C 200 300, 220 300, 238 300 Z"
