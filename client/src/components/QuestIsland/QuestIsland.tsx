        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-[1200px] h-[900px]">
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 900" style={{ zIndex: 50, pointerEvents: "none" }}>
              {/* Base Path */}
              <motion.path
                d="M 300 350 C 400 320, 500 280, 650 320 C 800 360, 900 320, 1000 350 C 1050 370, 1080 420, 1050 480 C 1020 540, 980 580, 920 600 C 860 620, 800 630, 750 620 C 700 610, 650 580, 620 540 C 590 500, 580 460, 560 420 C 540 380, 500 360, 450 380 C 400 400, 380 450, 350 500 C 320 550, 300 580, 280 600 C 260 620, 250 640, 260 650 C 270 660, 290 650, 300 630 C 310 610, 300 580, 300 550 C 300 520, 300 490, 300 460 C 300 430, 300 390, 300 350 Z"
