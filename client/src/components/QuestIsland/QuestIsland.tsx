        ...
        <div className="absolute inset-0 flex items-center justify-center">
          <div className="relative w-[1200px] h-[900px]">
            ...
            <svg className="absolute inset-0 w-full h-full" viewBox="0 0 1200 900" style={{ zIndex: 50, pointerEvents: "none" }}>
              {/* Base Path */}
              <motion.path
                d="M 875 1125 C 1125 875, 1625 875, 1875 1125 C 2000 1250, 1950 1450, 1800 1550 C 1625 1650, 1450 1625, 1375 1500 C 1325 1425, 1300 1350, 1250 1300 C 1200 1250, 1150 1300, 1125 1375 C 1100 1450, 1050 1500, 950 1450 C 850 1400, 800 1300, 825 1200 C 850 1150, 875 1125, 875 1125 Z"
