        ...
        <AnimatePresence mode="wait">
          {currentMessage && (
            <motion.div
              ...
              className="absolute bottom-full right-0 mb-4 bg-white/95 backdrop-blur-sm rounded-2xl shadow-xl border border-white/20 p-4 max-w-md w-96"
            >
              <p
                className="text-sm text-gray-700 leading-relaxed font-medium mb-1 break-words hyphens-auto overflow-hidden"
