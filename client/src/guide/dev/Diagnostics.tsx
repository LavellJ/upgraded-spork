...
export default function Diagnostics() {
  ...
  return (
    <SimpleLayout title="System Diagnostics" subtitle="Runtime checks and health monitoring">
      ...
      <ListCard>
        <ListRow 
          icon={<span className="list-icon text-lg text-stone-700">{getVitalStatus('LCP', webVitals.LCP).status}</span>}
        ...
        <div className="divider" />
        <ListRow 
          icon={<span className="list-icon text-lg text-stone-700">{getVitalStatus('CLS', webVitals.CLS).status}</span>}
        ...
        <div className="divider" />
        <ListRow 
          icon={<span className="list-icon text-lg text-stone-700">{getVitalStatus('INP', webVitals.INP).status}</span>}
